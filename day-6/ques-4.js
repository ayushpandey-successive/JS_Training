/*Problem Statement: Create a class called `Person` that has properties for `firstName`, `lastName`, and `age`. The class should also have a method called `fullName` that returns the person's full name.
...
const averageage = Person.averageAge(
  person1,
  person2,
  person3,
  person4,
